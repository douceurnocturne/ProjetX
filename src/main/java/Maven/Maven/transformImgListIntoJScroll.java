...
public class transformImgListIntoJScroll extends JFrame {
	...
	public static JScrollPane method(final ArrayList<Img> imgList, final Map _map) {
		...
		//création d'un GridBagContraints pour afficher seulement sur une colonne
		...
		for (int i = 0; i < imgList.size(); i++) {
			...
			//création d'un CustomJLabel permettant l'ajout d'un indice sur chaque JLabel
			JLabel label = new CustomJLabel(i);
			
			label.addMouseListener(new MouseAdapter() {
				public void mouseClicked(MouseEvent e) {
					//permet de dire sur quelle image nous cliquons et permet de centrer la vision de la map sur
